...
@Aspect
public class RoleAudit extends GenericAudit{

	private static final Logger logger = Logger.getLogger(RoleAudit.class);
	private static final String AOP_SERVICE = "RoleService";
	private static final String AOP_DAONAME = "RoleDao";
	private static final String AOP_GET_ALL_SERVICE = "execution(* com.hn.service.role.RoleService.getAll(..))";
	private static final String AOP_GET_ALL_DAO = "execution(* com.hn.dao.role.RoleDao.getAll(..))";
	private static final String AOP_ADD_SERVICE = "execution(* com.hn.service.role.RoleService.add(..))";
	private static final String AOP_INSERT_DAO = "execution(* com.hn.dao.role.RoleDao.insert(..))";
	private static final String AOP_EDIT_SERVICE = "execution(* com.hn.service.role.RoleService.edit(..))";
	private static final String AOP_UPDATE_DAO = "execution(* com.hn.dao.role.RoleDao.update(..))";
	private static final String AOP_DELETE_SERVICE = "execution(* com.hn.service.role.RoleService.delete(..))";
	private static final String AOP_DELETE_DAO = "execution(* com.hn.dao.role.RoleDao.delete(..))";
