...
@Aspect
public class CategoryAudit extends GenericAudit{

	private static final Logger logger = Logger.getLogger(CategoryAudit.class);
	private static final String AOP_SERVICE = "CategoryService";
	private static final String AOP_DAONAME = "CategoryDao";
	private static final String AOP_GET_ALL_SERVICE = "execution(* com.hn.service.category.CategoryService.getAll(..))";
	private static final String AOP_GET_ALL_DAO = "execution(* com.hn.dao.category.CategoryDao.getAll(..))";
	private static final String AOP_ADD_SERVICE = "execution(* com.hn.service.category.CategoryService.add(..))";
	private static final String AOP_INSERT_DAO = "execution(* com.hn.dao.category.CategoryDao.insert(..))";
	private static final String AOP_EDIT_SERVICE = "execution(* com.hn.service.category.CategoryService.edit(..))";
	private static final String AOP_UPDATE_DAO = "execution(* com.hn.dao.category.CategoryDao.update(..))";
	private static final String AOP_DELETE_SERVICE = "execution(* com.hn.service.category.CategoryService.delete(..))";
	private static final String AOP_DELETE_DAO = "execution(* com.hn.dao.category.CategoryDao.delete(..))";
