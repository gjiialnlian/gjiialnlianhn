...
@Aspect
public class LoginAudit extends GenericAudit{

	private static final Logger logger = Logger.getLogger(LoginAudit.class);
	private static final String AOP_SERVICE = "LoginService";
	private static final String AOP_DAONAME = "LoginDao";
	private static final String AOP_GET_ALL_SERVICE = "execution(* com.hn.service.login.LoginService.getAll(..))";
	private static final String AOP_GET_ALL_DAO = "execution(* com.hn.dao.login.LoginDao.getAll(..))";
	private static final String AOP_ADD_SERVICE = "execution(* com.hn.service.login.LoginService.add(..))";
	private static final String AOP_INSERT_DAO = "execution(* com.hn.dao.login.LoginDao.insert(..))";
	private static final String AOP_EDIT_SERVICE = "execution(* com.hn.service.login.LoginService.edit(..))";
	private static final String AOP_UPDATE_DAO = "execution(* com.hn.dao.login.LoginDao.update(..))";
	private static final String AOP_DELETE_SERVICE = "execution(* com.hn.service.login.LoginService.delete(..))";
	private static final String AOP_DELETE_DAO = "execution(* com.hn.dao.login.LoginDao.delete(..))";
